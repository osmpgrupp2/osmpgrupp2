...
//        counter = temp;
//        __sync_val_compare_and_swap(&counter, temp, __sync_add_and_fetch(&temp, INCREMENT_VALUE));
        __sync_add_and_fetch(&counter, INCREMENT_VALUE);
    }
...
//        counter = temp;
//        __sync_val_compare_and_swap(&counter, temp, __sync_sub_and_fetch(&temp, DECREMENT_VALUE));
        __sync_sub_and_fetch(&counter, DECREMENT_VALUE);
    }
